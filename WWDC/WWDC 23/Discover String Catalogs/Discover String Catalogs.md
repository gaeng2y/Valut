...
![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507121513.png?raw=true)
...
![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507121537.png?raw=true)
...
![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507121555.png?raw=true)
...
![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507121642.png?raw=true)

C 또는 Obj-C에서 직접 만든 현지화 문자열 매크로를 써려면 Localized String Macro Names에 추가해라!

![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507121651.png?raw=true)

코드에서의 방법을 살펴봤으니 이제 IB에서 현지화 가능한 문자열을 살펴보자.

지정된 문자열은 자동으로 현지화 가능하다고 간주된다.

![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507121659.png?raw=true)

인스펙터를 사용해 이런 문자열에 주석을 지정하여 해당 스트링이 표시될 위치 콘텍스트를 번역가에게 제공한다.

![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507121708.png?raw=true)

String Catalog를 스토리보드 또는 xib와 페어링하면 IB에서 현지화 가능한 모든 문자열이 Catalog에 표시된다.

![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507121717.png?raw=true)
...
![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507121726.png?raw=true)

소스 코드 문자열은 현지화 가능한 문자열의 소스 역할을 하는 반면 String Catalog의 소스 문자열은 동기화가 유지된다.

![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507121734.png?raw=true)

새 문자열이 추가되면 Xcode는 String Catalog에 문자열을 추가한다.

![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507121747.png?raw=true)

이 시점에서 문자열은 번역할 준비가 완료된다. 앞서 설명했듯이 현지화 가능한 문자열의 코드에 기본 소스값이 지정될 수 있다. 그런 경우 Catalog는 코드의 새 값으로 업데이트된다.

![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507121758.png?raw=true)
...
![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507121808.png?raw=true)
...
![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507121825.png?raw=true)

코드에서 문자열을 더 이상 찾을 수 없을 때 STALE 표시를 한다고 알려주었지만 그 외에도 알아두면 좋을 현지화 상태가 세 가지 더 있다.

![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507121904.png?raw=true)
...
![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507121914.png?raw=true)
...
![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507121931.png?raw=true)

두 개의 변수로 복수 변형을 사용해야 하는 더 복잡한 예시를 봐보자. 런타임에서 몇 가지 다른 시나리오가 발생할 것이다. 아래와 같은 경우에 숫자 주변의 문자열을 조금씩 다르게 번역해야 한다.

![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507122013.png?raw=true)

이때 치환이 필요하다. 여기서는 문자열의 두 인수를 모두 복수형으로 변형했다. 앞에 @ 기호가 붙은 치환에 복수형 딕셔너리와 그 값을 지정한다.

![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507134408.png?raw=true)
...
![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507134416.png?raw=true)
## Export
...
![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507134427.png?raw=true)

빌드 시에는 .strings 및 .stringdict 파일로 컴파일된다. OS에서 수년간 지원해 왔던 파일 형식이기 때문에 최소 배포 대상을 업데이트할 필요 없이 바로 사용할 수 있다.

![](https://github.com/gaeng2y/Valut/blob/main/𐂮%20Resources/Pasted%20image%2020240507134435.png?raw=true)
